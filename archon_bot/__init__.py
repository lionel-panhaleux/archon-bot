...
async def on_message(message: discord.Message):
    ...
    command, update = {
        ...
        "specialfix": (Command.specialfix, True),
...
"""
    ...
    async def open(self, rounds, *args):
        ...
        channel = await self.guild.create_text_channel(
            ...
            overwrites={
                self.guild.default_role: NO_TEXT,
                judge_role: TEXT,
            },
        )
        ...
        channel = await self.guild.create_voice_channel(
            ...
            category=self.category,
            overwrites={
                self.guild.default_role: NO_VOICE,
                judge_role: VOICE,
            },
        )
    ...
    async def seat(self):
        ...
        if self.tournament.finals:
            ...
            channel = await self.guild.create_text_channel(
                ...
                category=self.category,
                overwrites={
                    self.guild.default_role: SPECTATE_TEXT,
                    judge_role: TEXT,
                    table_role: TEXT,
                },
            )
            ...
            channel = await self.guild.create_voice_channel(
                ...
                overwrites={
                    self.guild.default_role: NO_VOICE,
                    spectator_role: SPECTATE_VOICE,
                    judge_role: JUDGE_VOICE,
                    table_role: VOICE,
                },
            )
    ...
    async def specialfix(self):
        await self._check_judge_private()
        self.tournament.player_numbers.pop(102)
        self.tournament.seating[-1].remove(102)
        self.tournament.dropped.add("4870008")
        self.tournament.player_numbers.pop(103)
        self.tournament.seating[-1].remove(103)
        self.tournament.dropped.add("6360002")
        self.update()
